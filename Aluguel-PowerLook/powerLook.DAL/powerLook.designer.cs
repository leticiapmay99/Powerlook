...
namespace powerLook.DAL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="PowerLook_DB")]
    ...
    partial void InsertCores(Cores instance);
    partial void UpdateCores(Cores instance);
    partial void DeleteCores(Cores instance);
    ...
    partial void InsertProdutosCores(ProdutosCores instance);
    partial void UpdateProdutosCores(ProdutosCores instance);
    partial void DeleteProdutosCores(ProdutosCores instance);
    ...
    partial void DeleteTipoUsuario(TipoUsuario instance);
		...
		public powerLookDataContext() : 
				base(global::powerLook.DAL.Properties.Settings.Default.PowerLook_DBConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Cores> Cores
		{
			get
			{
				return this.GetTable<Cores>();
			}
		}
		...
		public System.Data.Linq.Table<ProdutosCores> ProdutosCores
		{
			get
			{
				return this.GetTable<ProdutosCores>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Cores")]
	public partial class Cores : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ProdutosCores> _ProdutosCores;
    ...
    partial void OnnameChanged();
		...
		public Cores()
		{
			this._ProdutosCores = new EntitySet<ProdutosCores>(new Action<ProdutosCores>(this.attach_ProdutosCores), new Action<ProdutosCores>(this.detach_ProdutosCores));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cores_ProdutosCores", Storage="_ProdutosCores", ThisKey="id", OtherKey="id_cor")]
		public EntitySet<ProdutosCores> ProdutosCores
		{
			get
			{
				return this._ProdutosCores;
			}
			set
			{
				this._ProdutosCores.Assign(value);
			}
		}
		...
		private void attach_ProdutosCores(ProdutosCores entity)
		{
			this.SendPropertyChanging();
			entity.Cores = this;
		}
		
		private void detach_ProdutosCores(ProdutosCores entity)
		{
			this.SendPropertyChanging();
			entity.Cores = null;
		}
    ...
    partial void Ondata_nascimentoChanging(string value);
    ...
    partial void Onid_enderecoChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_data_nascimento", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
    ...
    partial void Onid_fornecedorChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_imagem", DbType="NVarChar(255)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Produtos_ProdutosCores", Storage="_ProdutosCores", ThisKey="id", OtherKey="id_produto")]
		public EntitySet<ProdutosCores> ProdutosCores
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ProdutosCores")]
	public partial class ProdutosCores : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Cores> _Cores;
    ...
    partial void Onid_corChanged();
		...
		public ProdutosCores()
		{
			this._Cores = default(EntityRef<Cores>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_id_cor", DbType="Int NOT NULL")]
		public int id_cor
		{
			get
			{
			...
			set
			{
				...
				{
					if (this._Cores.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cores_ProdutosCores", Storage="_Cores", ThisKey="id_cor", OtherKey="id", IsForeignKey=true)]
		public Cores Cores
		{
			get
			{
				return this._Cores.Entity;
			}
			set
			{
				Cores previousValue = this._Cores.Entity;
				if (((previousValue != value) 
							|| (this._Cores.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Cores.Entity = null;
						previousValue.ProdutosCores.Remove(this);
					}
					this._Cores.Entity = value;
					if ((value != null))
					{
						value.ProdutosCores.Add(this);
						this._id_cor = value.id;
					}
					else
					{
						this._id_cor = default(int);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Produtos_ProdutosCores", Storage="_Produtos", ThisKey="id_produto", OtherKey="id", IsForeignKey=true)]
